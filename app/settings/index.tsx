...
export default function SettingsScreen() {
  ...
  const confirmClearData = () => {
    Alert.alert(
      'Удалить все данные?',
      'Будут удалены все проекты, расходы, бюджеты, исполнители и фотографии. Это действие нельзя отменить.',
      [
    ...
    <ScreenLayout title="Настройки">
      ...
      <Card style={styles.card}>
        <Card.Content>
          ...
          <Text variant="bodySmall" style={styles.muted}>
            Удаляет все проекты, расходы, бюджеты, исполнителей и фотографии с
            устройства.
          </Text>
          <Button
            mode="outlined"
